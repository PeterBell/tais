...
const content = {
    ...
    text: {
      title: "Empowering Engineering Leaders",
      highlight: "Globally",
      description:
...
function About() {
  return (
    <section id={content.section.id} className="w-full py-12 md:py-24 lg:py-32">
      ...
      <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
        ...
        <div className="space-y-6 text-center lg:text-left">
          <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">
            {content.text.title}{" "}
            <span className="text-[#58B4FF]">{content.text.highlight}</span>
          </h2>
        ...
        <div className="relative flex justify-center">
          ...
          <div className="overflow-hidden rounded-2xl">
            <Image
              alt="About Us Image - Petter Bell CEO"
