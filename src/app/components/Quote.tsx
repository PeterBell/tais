        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col items-center">
            ...
            <cite className="not-italic">
              ...
              <span className="text-gray-600">{content.quote.role}</span>
            </cite>
          </div>
        </div>
      </div>
